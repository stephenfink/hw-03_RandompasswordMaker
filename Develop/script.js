...
function generatePassword() {
  passWordLength();
  var upperCase = confirm("do you want upper case? yes or no");
  if (upperCase === true) {
  ...
  var lowerCase = confirm("do you want lower case? yes or no");
  if (lowerCase === true) {
  ...
  var numCase = confirm("do you want numbers? yes or no");
  if (numCase === true) {
...
function buildPassFun(caseUpper, caseLower, caseNum, symbolLetters){
 var password = ""
